...
// reject函数
function reject (id){
  return fetch(location.origin + '/api/exchange/record_status',{
    method: 'POST',
    headers: {
    ...
    body: JSON.stringify({
      id: id,
      note: "",
      reason: "Mohon maaf, kami telah membayar untuk nomor ini tetapi gagal, silakan redeem lagi ke platform lain yang terdaftar pakai nomor akun jadiduit misalnya OVO, GOPAY,ShopeePay dan Linkaja.  Atau Anda dapat menghubungi kami melalui Facebook (jadiduit_indonesia) untuk ganti nomor, terima kasih banyak.",
      status: "3"
    }),
